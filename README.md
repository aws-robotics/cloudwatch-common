...
* Travis CI:
    ...
    * "release" branch [![Build Status](https://travis-ci.org/aws-robotics/cloudwatch-common.svg?branch=release-v1)](https://travis-ci.org/aws-robotics/cloudwatch-common/branches)
* ROS build farm:
