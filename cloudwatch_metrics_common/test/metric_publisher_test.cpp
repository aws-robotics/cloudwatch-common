...
TEST_F(TestMetricPublisherFixture, TestLogPublisher_PublishLogs_ReturnsFalseWhenEmpty)
{
  ...
  EXPECT_EQ(Aws::FileManagement::UploadStatus::FAIL, publisher_->attemptPublish(test_list));
...
{
  EXPECT_EQ(Aws::FileManagement::UploadStatus::SUCCESS, publisher_->attemptPublish(metrics_list_));
